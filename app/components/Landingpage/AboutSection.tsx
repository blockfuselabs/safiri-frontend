      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <p className="text-lg text-[#343444]/80 animate-fade-in">
            Blockchain-powered financial revolution, connecting African
            economies with lightning speed and unparalleled security.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="max-w-5xl w-full">
            ...
            hover:border-[#c4fc74] ${feature.animation} opacity-0`}
                  >
                    <div
                      className={`h-12 w-12 rounded-xl ${feature.color} flex items-center justify-center mb-4 
              transform transition duration-300 group-hover:rotate-12`}
                    >
                      {feature.icon}
                    </div>
                    <h4 className="text-lg font-bold mb-2 text-[#343444]">
                      {feature.title}
                    </h4>
                    <p className="text-[#343444]/80 text-sm">{feature.desc}</p>
                  </div>
                ))}
              </div>
