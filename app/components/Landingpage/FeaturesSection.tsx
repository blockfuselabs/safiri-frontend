      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <p className="text-lg text-[#343444]/80">
            ...
            making financial transfers seamless and secure.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={index} className="group animate-flip   ">
              <div className="bg-white rounded-2xl p-8 border border-[#343444]/10 shadow-sm transition duration-300 hover:shadow-xl hover:-translate-y-1 card-inner relative w-full h-full">
                ...
                <div className="pt-4 border-t border-[#343444]/10 card-back">
          ...
          {[
            {
              ...
              title: "Crypto-Powered Transfers",
              description:
                "Lightning-fast settlements on StarkNet with unparalleled security and minimal fees.",
              items: [
                "Zero-knowledge proofs",
                "Low transaction costs",
                "Instant cross-border transfers",
            ...
            },
            {
              ...
              title: "Flexible Funding Options",
              description:
                "Seamlessly convert local currency to crypto with competitive exchange rates.",
              items: [
                "Multiple payment methods",
                "Transparent conversions",
                "Competitive rates",
            ...
            },
            {
              ...
              title: "Universal Accessibility",
              description:
                "Send and receive money across multiple platforms, including low-tech solutions.",
              items: ["Web platform", "Mobile apps", "USSD service"],
              link: "Access Channels",
            },
          ].map((feature, index) => (
            <div key={index} className="animate-flip group relative">
              <div className="card-inner relative w-full h-full">
                {/* Front Side */}
                {/* <div className="card-front">
                  <div className="h-16 w-16 rounded-xl bg-[#c4fc74]/20 flex items-center justify-center mb-6">
                    {feature.icon}
                  </div>
                  ...
                  <ul className="space-y-4">
                    {feature.items.map((item, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <div className="h-5 w-5 rounded-full bg-[#c4fc74]/30 flex items-center justify-center mt-0.5">
                          <span className="text-[#343444] text-xs">✓</span>
                        </div>
                        <span className="text-sm text-[#343444]/80">
                          {item}
                        </span>
                      </li>
                    ))}
                ...
                {/* <div className="card-back">
                  <h3 className="text-xl font-bold mb-3">More About</h3>
                  <p className="text-[#343444]/80 mb-6">{feature.link}</p>
                  <a
                    href="#"
                    className="inline-flex items-center gap-2 text-[#343444] font-medium hover:underline"
                  >
                    Learn More →
                  </a>
                </div>
        ...
        <div className="mt-24 relative">
          <div className="relative bg-white rounded-3xl shadow-xl overflow-hidden border border-[#343444]/10 p-12">
            <div className="text-center mb-12">
              ...
              <h3 className="text-3xl font-bold mb-4 text-[#343444]">
                How Safiri Send Works
              </h3>
              <p className="text-[#343444]/80 max-w-xl mx-auto">
                A seamless three-step process built on blockchain technology for
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-6 relative">
              ...
              <div className="group">
                <div className="bg-white rounded-2xl p-8 border border-[#343444]/10 shadow-sm relative z-10 h-full transition duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <h4 className="text-xl font-semibold mb-4 text-[#343444]">
                    Fund Your Wallet
                  </h4>
                  <p className="text-[#343444]/80 text-sm mb-6">
                    Add money to your Safiri Send wallet using bank transfer,
                    mobile money, or card payment in your local currency.
                  </p>
                      ...
                      {[
                        {
                          icon: (
                            <CreditCard
                              size={24}
                              className="text-[#343444]/60"
                            />
                          ),
                        },
                        {
                          icon: (
                            <Globe size={24} className="text-[#343444]/60" />
                          ),
                        },
                        {
                          icon: (
                        ...
                        <div
                          key={i}
                          className="h-16 bg-white rounded-lg shadow-sm flex items-center justify-center"
                        >
                          {item.icon}
                        </div>
                      ))}
              ...
              <div className="group">
                <div className="bg-white rounded-2xl p-8 border border-[#343444]/10 shadow-sm relative z-10 h-full transition duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <p className="text-[#343444]/80 text-sm mb-6">
                    Specify recipient details, amount, and destination country.
                    Funds are converted and settled on StarkNet.
                  </p>
                  <div className="w-full bg-[#f6f6f6] rounded-xl border border-[#343444]/10 flex items-center justify-center p-6">
                    <div className="space-y-4 w-full">
                      ...
                      <div className="h-10 bg-[#c4fc74] rounded-lg w-full flex items-center justify-center shadow-sm">
                        <span className="text-sm font-semibold text-[#343444]">
                          Send Now
                        </span>
                      </div>
                    </div>
              ...
              <div className="group">
                <div className="bg-white rounded-2xl p-8 border border-[#343444]/10 shadow-sm relative z-10 h-full transition duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <p className="text-[#343444]/80 text-sm mb-6">
                    Recipients get an instant notification and can withdraw to
                    their bank account or mobile money in local currency.
                  </p>
                  <div className="w-full bg-[#f6f6f6] rounded-xl border border-[#343444]/10 flex items-center justify-center p-6">
                    <div className="space-y-4 w-full">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <div className="h-8 px-4 bg-[#c4fc74]/20 rounded-full flex items-center justify-center shadow-sm">
                          <span className="text-xs text-[#343444] font-semibold">
                            Received
                          </span>
                        </div>
                      </div>
            ...
            <div className="flex justify-center mt-16">
              <a
                href="#"
                className="group inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#c4fc74] text-[#343444] font-medium hover:shadow-lg transition-all shadow-md"
              >
                <Cpu size={20} />
